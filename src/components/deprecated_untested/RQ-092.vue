<template>
    <div class="rq-092-container" :style="this.style" :class="classes">
        <template v-for="content in contents">
            ...
            <RQ_090 v-if="content.type == 'bulletList'" :title="content.title" :text="content.text"
                    :options="content.options" :checked="content.checked"/>
            <RQ_091 v-if="content.type == 'quote'" :text="content.text" :src="content.src"
                    :description="content.description" :name="content.name"/>
            <RQ_021 v-if="content.type == 'image'" :src="content.src" class="rq-092-image" :size="content.size"
                    :title="content.title"/>
            <Profile_Card v-if="content.type == 'profile-card'" :src="content.src" class="rq-092-profile-card"
                          :title="content.title" :description="content.description" :contact="content.contact"/>
