<template>
    <div class="rq-007" :class="backgroundCSSClass" v-if="contents">
        <div class="rq-007-content">
            <template v-for="content in contents">
                <RQ_090 v-if="content.type == 'bulletList'" class="rq-007-bulletlist" v-bind:options="content.options"
                        :title="content.title" :text="content.text" size="H2"/>
                <RQ_011 v-if="content.type == 'textWithIcon'" size="H2" class="rq-007-textWithIcon" count="1"
                        :title="content.title" :text="content.text"/>
                <RQ_008 v-if="content.type == 'header'" class="rq-007-header" :title="content.title" size="H2"/>
                <RQ_012 v-if="content.type == 'textInColumns'" class="rq-007-textInColumns" :cols="content.cols"
                        :title="content.title" :text="content.text"/>
